...
const AsideBox: React.FC<AsideBoxProps> = ({variant}) => {
    ...
    if (variant === "register") {
        ...
        content = <>
            <div className="flex flex-row px-2 lg:px-4 align-middle justify-between basetext">
                <p className="text-text">Posts:</p>
                <p className="text-clr_primary">0</p>
            </div>
            <div className="flex flex-row px-2 lg:px-4 align-middle justify-between basetext">
                <p className="text-text">Images:</p>
                <p className="text-clr_primary">0</p>
            </div>
            <div className="flex flex-row px-2 lg:px-4 align-middle justify-between basetext">
                <p className="text-text">Online users:</p>
                <p className="text-clr_primary">0</p>
            </div>
    ...
    return (
        <div className="flex flex-col gap-y-2">
            ...
            <div id="AsideBoxContent" className="flex flex-col gap-y-2 p-2 bg-background2">
                {content}
            </div>
        </div>
    );
